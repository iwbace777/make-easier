module PublishHelper
  def not_ready_message
    ...
    let_us_know_link = mail_to 'service@getMakeEasier.com', 'let us know'
  ...
  def everything_up_to_date
    "Everything for your app is published and up to date! Please note that most of the changes you make on MakeEasier are effective immediately in your app. To see changes, quit and restart your app."
  end
