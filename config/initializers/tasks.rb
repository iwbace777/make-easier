...
initial << Task.new("Select Your Account Package", 'fa-th-large', 'accounts_MakeEasier_packages_path', 'Choose your level of service for your app and unlock additional features from MakeEasier.') do |user|
