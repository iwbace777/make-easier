...
Rails.application.routes.draw do
  ...
  namespace :v1 do
    ...
    defaults format: 'json' do
      get 'com.MakeEasier.:bundle_suffix/config' => 'app_configuration#config_json', as: :app_configuration
  ...
  namespace :accounts, path: 'account' do
    # PACKAGES
    resource :packages, only: [:show, :update], path: 'MakeEasier-packages', as: 'MakeEasier_packages'
